...
const config: Config = {
  title: 'Kadouri CRM',
  tagline: 'Enterprise Order Management System for Agricultural Sales',
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl: 'https://github.com/mailumaoc/pace-crm/tree/main/docs/',
        },
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Kadouri CRM. All rights reserved.`,
    },
    prism: {

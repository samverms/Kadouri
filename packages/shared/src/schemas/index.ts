...
export const createOrderSchema = z.object({
  ...
  sellerBillingAddressId: z.string().uuid().optional(),
  sellerPickupAddressId: z.string().uuid().optional(),
  buyerBillingAddressId: z.string().uuid().optional(),
  buyerShippingAddressId: z.string().uuid().optional(),
  ...
  contractDrawQuantity: z.number().optional(),
